...
class TestView(TestCase):
    ...
    def test_post_list(self):
        ...
        self.assertIn(self.user_kyounghoon1.username.upper(), main_area.text)
        self.assertIn(self.user_kyounghoon2.username.upper(), main_area.text)
    ...
    def test_post_detail(self):
        ...
        self.assertIn(self.user_kyounghoon1.username.upper(), post_area.text)
    ...
    def test_create_post(self):
        ...
        main_area = soup.find('div', id='main-area')
        self.assertTrue('Create New Post', main_area.text)
    ...
    def test_update_post(self):
        ...
        # 로그인은 했지만 작성자가 아닌 경우
        self.assertNotEqual(self.post_003.author, self.user_kyounghoon1)
        self.client.login(
            username=self.user_kyounghoon1.username,
    ...
    def test_comment_form(self):
        ...
        self.assertIn('kyounghoon1', new_comment_div.text)
        self.assertIn('kyounghoon1의 댓글입니다.', new_comment_div.text)


    def test_comment_update(self):
        comment_by_kyounghoon2 = Comment.objects.create(
            post=self.post_001,
            author=self.user_kyounghoon2,
            content='kyounhoon2의 댓글입니다.'
        )
        ...
        response = self.client.post(
            ...
            {
                'content': 'kyounghoon1의 댓글을 수정합니다.',
            },
            follow=True
        )
        ...
        self.assertIn('kyounghoon1의 댓글을 수정합니다.', comment_001_div.text)
    ...
    def test_delete_comment(self):
        ...
        self.assertIn(self.post_001.title, soup.title.text)
        comment_area = soup.find('div', id='comment-area')
        self.assertNotIn('kyounghoon2의 댓글입니다.', comment_area.text)
